    ...
    "projects": [
        ...
        },
        {
            ...
            "description": [
                ...
                "Впровадив пайплайн автоматизованої обробки вхідних документів (Word, PDF) з використанням технологій OCR для зчитування тексту зі сканів та інтегрував великі мовні моделі (LLM) для розумної екстракції, розпізнавання та структурування даних із неструктурованого тексту.",
                'Налаштував алгоритми очищення та агрегації розпізнаної інформації з подальшим автоматичним додаванням до зведених таблиць за допомогою Pandas, реалізувавши зручний та інтерактивний користувацький інтерфейс на базі Streamlit.'
            ],
            "tech": 'Python, Streamlit, Pandas, LLM APIs, OCR, інструменти парсингу документів',
            "link": None
        },
        {
            'name' : 'Tunescope - аналог Shazam',
            'description': ['Розробив вебзастосунок для точного розпізнавання музичних треків із мікрофона або завантажених файлів',
                            'Імплементував пайплайн цифрової обробки сигналів (DSP), який включає побудову спектрограм (STFT), виділення локальних піків (Constellation Map) та генерацію комбінаторних 30-бітних хешів для кожної секунди аудіо.',
                            'Спроєктував швидку систему пошуку співпадінь за алгоритмом гістограм часових зсувів (Time Offset Histogram) та налаштував модуль автоматизованого поповнення бази даних аудіозаписами безпосередньо з YouTube.'
                ],
